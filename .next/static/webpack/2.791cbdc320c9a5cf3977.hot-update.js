...
var CanvasicalSmoke = function CanvasicalSmoke(props) {
  ...
  var _useState = useState({
    ...
    delay: null
      ...
      _useState2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_7__["default"])(_useState, 1),
      smokeSettings = _useState2[0];

  var smokeClear = {
    opacity: 0,
    transition: "".concat(smokeSettings.fadeIn, "ms ease opacity 0ms")
  };
  var smokeOpaque = {
    opacity: 1,
    transition: "".concat(smokeSettings.fadeIn, "ms ease opacity 0ms")
  ...
  var _useState3 = useState(_objectSpread({}, smokeClear)),
      _useState4 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_7__["default"])(_useState3, 2),
      smokeStyle = _useState4[0],
      setSmokeStyle = _useState4[1];

  Object(react__WEBPACK_IMPORTED_MODULE_8__["useEffect"])(function () {
    if (smokeStyle === smokeClear && canvas.load) {
...
//# sourceMappingURL=2.791cbdc320c9a5cf3977.hot-update.js.map