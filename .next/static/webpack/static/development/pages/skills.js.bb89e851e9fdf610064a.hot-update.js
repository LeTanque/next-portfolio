...
var Lighting = function Lighting() {
  ...
  var light = Object(react__WEBPACK_IMPORTED_MODULE_1__["useRef"])(); // useFrame(() => {
  //     light.current.position.set( mouse.x / 20, -mouse.y / 20, 50 )
  // });

  console.log('mouse.x / 20 --> ', mouse.x);
  console.log('light --> ', light);
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx("pointLight", {
    ref: light,
    distance: 50,
    position: [-2, 0, 40],
    intensity: 1.5,
...
//# sourceMappingURL=skills.js.bb89e851e9fdf610064a.hot-update.js.map