...
var GenerateSmoke = function GenerateSmoke(_ref) {
  ...
  Object(react_three_fiber__WEBPACK_IMPORTED_MODULE_2__["useFrame"])(function (_ref2) {
    ...
    var delta = clock.getDelta(); // ref.current.rotation.z = ((clock.elapsedTime) / (clock.elapsedTime - delta));
    // ref.current.rotation.z = Math.tan(clock.elapsedTime * Math.PI / 180);

    ref.current.rotation.z += delta * 0.1 + 0.001; // ref.current.rotation.z +=  Math.tan(Math.sqrt(3)) ;
...
//# sourceMappingURL=skills.js.2e5d365fc06d56d5f67a.hot-update.js.map