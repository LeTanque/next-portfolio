...
function SmokePuff(_ref) {
  ...
  Object(react_three_fiber__WEBPACK_IMPORTED_MODULE_3__["useFrame"])(function (_ref2) {
    ...
    smokePuffRef.current.rotation.z = clock.elapsedTime * (delta + 0.017) * randomFactor; // Slow and pretty steady. Random factor

    smokePuffRef.current.rotation.set(0, 0, s * 5);
    smokePuffRef.current.position.set(xFactor + Math.cos(t / 30 * factor) + Math.sin(t * 1) * factor / 10, yFactor + Math.sin(t / 20 * factor) + Math.cos(t * 2) * factor / 10, zFactor + Math.cos(t / 10 * factor) + Math.sin(t * 3) * factor / 20);
  });
  return __jsx("mesh", {
    ref: smokePuffRef,
    material: material,
...
//# sourceMappingURL=skills.js.68d1a876d369ecd13a9a.hot-update.js.map