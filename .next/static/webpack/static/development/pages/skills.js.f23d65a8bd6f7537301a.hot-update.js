...
var GenerateSmoke = function GenerateSmoke(_ref) {
  ...
  var slowsThenStops = Math.tanh(clock.elapsedTime); // let xFactor = 1;
  // let yFactor = 1;
  // let zFactor = 2;
  // let rotationAngle = Math.random() * 360;
  // let factor = 0.1;
  ...
  Object(react_three_fiber__WEBPACK_IMPORTED_MODULE_2__["useFrame"])(function (_ref2) {
    ...
    ref.current.rotation.z = Math.tanh(clock.elapsedTime / 2);
...
//# sourceMappingURL=skills.js.f23d65a8bd6f7537301a.hot-update.js.map