...
var Index = function Index() {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])({
    ...
    delay: 1500
      ...
      setFogScrollSettings = _useState2[1];

  var foggyLettersClear = {
    opacity: 0,
    transition: "".concat(fogScrollSettings.fadeIn, "ms ease opacity ").concat(fogScrollSettings.delay, "ms")
  };
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])(_objectSpread({}, foggyLettersClear)),
      fogScrollStyle = _useState3[0],
      setFogScrollStyle = _useState3[1];

  var fogScrollerClasses = ["scroller-top", "scroller-middle", "scroller-bottom"]; // loading trigger to turn fog on
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_8___default.a.Fragment, null, __jsx("section", {
    ...
    __self: this
  }, "le\xA0"), "tanque") : null)), fogScrollerClasses.map(function (position, index) {
...
//# sourceMappingURL=index.js.71cea01355c4d5a9cd5d.hot-update.js.map