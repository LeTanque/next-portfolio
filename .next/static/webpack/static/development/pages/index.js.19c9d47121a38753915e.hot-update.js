...
var Index = function Index() {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])({
    display: false
      ...
      setBlockGreeting = _useState[1];

  var scrollerClassNames = ["scroller-top", "scroller-middle", "scroller-bottom"]; // Fog delay and transition styling

  var fogFadeIn = 5555;
  var fogDelay = 1500;
  var foggyLettersClear = {
    opacity: 0,
    transition: "".concat(fogFadeIn, "ms ease opacity ").concat(fogDelay, "ms")
  };
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_8__["useState"])(_objectSpread({}, foggyLettersClear)),
      fogScroll = _useState2[0],
      setFogScroll = _useState2[1]; // loading trigger to turn fog on


  Object(react__WEBPACK_IMPORTED_MODULE_8__["useEffect"])(function () {
    var timer = setTimeout(function () {
      setFogScroll(_objectSpread({}, foggyLettersOpaque));
    }, fogDelay);
    return function () {
...
//# sourceMappingURL=index.js.19c9d47121a38753915e.hot-update.js.map