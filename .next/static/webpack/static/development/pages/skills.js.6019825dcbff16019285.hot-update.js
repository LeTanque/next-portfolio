...
var SmokeParticle = function SmokeParticle() {
  ...
  //     scene,                        // Default scene
  // } = useThree();
  var smokeParticleRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])();
  ...
  Object(react_three_fiber__WEBPACK_IMPORTED_MODULE_2__["useFrame"])(function (_ref) {
...
var GenerateSmoke = function GenerateSmoke(_ref2) {
  var particleArray = _ref2.particleArray; // const { clock } = useThree();

  var ref = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(); // let xFactor = 1;
  // let yFactor = 1;
  // let zFactor = 2;
  // let rotationAngle = Math.random() * 360;
  // let factor = 0.1;
  ...
  Object(react_three_fiber__WEBPACK_IMPORTED_MODULE_2__["useFrame"])(function (_ref3) {
    // let delta = clock.getDelta();
  ...
  return (// <mesh 
    ...
    //     <SmokeParticle  />
    // </mesh>
    __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, particleArray.map(function (eachParticle, index) {
...
//# sourceMappingURL=skills.js.6019825dcbff16019285.hot-update.js.map